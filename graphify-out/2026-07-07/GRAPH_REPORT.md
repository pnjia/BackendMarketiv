...
## Corpus Check
- 270 files · ~100,069 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2436 nodes · 2497 edges · 238 communities (233 shown, 5 thin omitted)
...
## Communities (238 total, 5 thin omitted)
...
## Knowledge Gaps
- **1499 isolated node(s):** `$schema`, `paths`, `plugin`, `@opencode-ai/plugin`, `name` (+1494 more)
