...
## Corpus Check
- 261 files · ~100,446 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2406 nodes · 2492 edges · 222 communities (215 shown, 7 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `843607d7`
...
- [[_COMMUNITY_chat.service.js|chat.service.js]]
- [[_COMMUNITY_notification.service.js|notification.service.js]]
...
## Communities (222 total, 7 thin omitted)
...
Cohesion: 0.25
Nodes (7): Chat — Testing, Conversation, Di Luar MVP, Notifikasi, Offer dari Chat, Pesan, Realtime
...
Cohesion: 0.20
Nodes (14): buildLastMessage(), ChatMessage, ChatServiceError, Conversation, createConversation(), CreateConversationInput, ensureParticipant(), mapConversation() (+6 more)
...
## Knowledge Gaps
- **1493 isolated node(s):** `$schema`, `paths`, `plugin`, `@opencode-ai/plugin`, `fs` (+1488 more)
...
- **Why does `ADR-001 — Gunakan Appwrite BaaS, Bukan Backend Custom` connect `ADR-001 — Gunakan Appwrite BaaS, Bukan Backend Custom` to `ADR-002 — Abstraksi Service Layer Wajib`?**
